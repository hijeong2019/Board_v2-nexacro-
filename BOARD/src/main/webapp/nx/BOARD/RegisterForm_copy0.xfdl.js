(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta00","37%","3.5%","210","54",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("회원가입");
            ...
            obj = new Edit("edt_Id","32.25%","19.50%","20.63%","27",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_displaynulltext("ID 입력");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00","32.25%","15%","68",null,null,"edt_Id:5",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("아이디");
            obj.set_font("bold 16px/19px \"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new Static("stc_Possible","32.25%","24.00%","146","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            ...
            obj = new Static("stc_Impossible","32.25%","24.17%","146","30",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            ...
            obj = new Static("sta00_00_00","32.25%","stc_Impossible:6.67%","68","22",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("비밀번호");
            obj.set_font("bold 16px/19px \"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_Pwd","32.25%","sta00_00_00:27.27%","20.63%","27",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_displaynulltext("PW 입력");
            obj.set_password("true");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_01","32.25%","edt_Pwd:66.67%","68","22",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("이름");
            obj.set_font("bold 16px/19px \"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_Name","32.25%","sta00_00_01:22.73%","20.63%","27",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_displaynulltext("홍길동");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_00_00","32.25%","edt_Name:55.56%","68","22",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("이메일");
            obj.set_font("bold 16px/19px \"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_Email","32.25%","sta00_00_00_00:22.73%","20.63%","27",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_displaynulltext("id@domain.com");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_01_00","32.25%","edt_Email:66.67%","68","22",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("성별");
            obj.set_font("bold 16px/19px \"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_Gender","32.25%","sta00_00_01_00:22.73%","143","29",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            ...
            obj = new Static("sta00_00_00_00_00","32.25%","rdo_Gender:34.48%","68","22",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("주소");
            obj.set_font("bold 16px/19px \"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_Address","32.25%","sta00_00_00_00_00:13.64%","20.63%","27",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_displaynulltext("Korea");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Register","32.25%","edt_Address:74.07%","20.63%","34",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("확인");
            ...
            obj = new Button("btn_Idchk","54.25%","19.33%","79","29",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("중복확인");
            obj.set_background("#5B92E4");
            obj.set_cursor("pointer");
            ...
            obj = new Button("btn_Back","54.25%","btn_Idchk:1317.24%","50","34",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("취소");
            obj.set_cursor("pointer");
            obj.set_boxShadow("1px 1px 2px 0px #7c7c7c");
        ...
        // User Script
        this.registerScript("RegisterForm_copy0.xfdl", function() {
        /**
        ...
        */
        ...
        this.loadIncludeScript("RegisterForm_copy0.xfdl");
