(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_reply","638","300",null,null,"-500","72",null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Div("div00","64","330","477","215",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_border("1px solid black");
            this.addChild(obj.name, obj);

            obj = new TextArea("txt_rcontents","31","46","354","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("2");
            this.div00.addChild(obj.name, obj);

            obj = new Static("sta_rwriter","31","16","86","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_border("1px solid");
            this.div00.addChild(obj.name, obj);

            obj = new Static("sta_rday","121","16","86","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("2");
            obj.set_text("");
            obj.set_border("1px solid");
            this.div00.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","div00.form.sta_rwriter","text","dsReplyList","writer");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div00.form.sta_rday","text","dsReplyList","reg_date");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","div00.form.txt_rcontents","value","dsReplyList","contents");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BoardlistForm_copy0.xfdl", function() {
        /************************************************************************************************
         * FORM 변수 선언 영역
         ************************************************************************************************/
        ...
        */
        ...
        this.loadIncludeScript("BoardlistForm_copy0.xfdl");
